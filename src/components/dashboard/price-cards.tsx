        ...
        <CardContent className="p-4">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-amber-100 to-yellow-100 dark:from-amber-900/30 dark:to-yellow-900/30 flex items-center justify-center shadow-sm">
                {icon}
              </div>
              <div>
              ...
              {hasBuySell ? (
                <div className="space-y-2.5">
                  <div className="grid grid-cols-2 gap-2.5">
                    <div className="bg-emerald-50/80 dark:bg-emerald-950/30 rounded-xl p-3 ring-1 ring-emerald-200/50 dark:ring-emerald-800/30">
                      <div className="flex items-center gap-1.5 mb-1.5">
                        <ArrowRightLeft className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
                        <span className="text-sm font-bold text-emerald-700 dark:text-emerald-400">بيع</span>
                      </div>
                      ...
                      <span className="text-xs font-medium text-muted-foreground">ج.م/جرام</span>
                    </div>
                    <div className="bg-sky-50/80 dark:bg-sky-950/30 rounded-xl p-3 ring-1 ring-sky-200/50 dark:ring-sky-800/30">
                      <div className="flex items-center gap-1.5 mb-1.5">
                        <ArrowDownUp className="w-3.5 h-3.5 text-sky-600 dark:text-sky-400" />
                        <span className="text-sm font-bold text-sky-700 dark:text-sky-400">شراء</span>
                      </div>
                      <p className="text-xl sm:text-2xl font-black tracking-tight text-foreground tabular-nums">
